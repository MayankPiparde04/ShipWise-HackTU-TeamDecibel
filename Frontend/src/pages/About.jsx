        ...
        <div className="bg-gradient-to-b from-gray-950 to-gray-900">
          ...
          <div className="flex justify-center my-8 items-center">
            ...
            >
              ...
              ShipWise integrates sustainability at every stage of the logistics process, ensuring minimal waste and maximum efficiency. Through optimized packaging, we reduce empty space and excess material usage, significantly cutting down on waste. Our smart buffering approach ensures that only the necessary protection is used, preventing material overuse. With EV route optimization, we plan the shortest and most energy-efficient delivery paths, reducing carbon emissions. Additionally, our batch delivery system consolidates multiple orders into a single trip, cutting fuel consumption and minimizing environmental impact. By embedding eco-driven logistics in every step, ShipWise is paving the way for a smarter, greener future.</p>
            </motion.section>
          </div>
