...
import ND from '../assets/Namish.jpg';
    ...
    return (
        <div className="flex justify-center my-8 items-center">
            ...
            >
                ...
                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-5 gap-8">
                    <TeamMember IMG={MP} name="Mayank Piparde" role="Full-Stack Developer" />
                    <TeamMember IMG={NS} name="Naman Shah" role="Backend Specialist" />
                    <TeamMember IMG={NM} name="Nitya Maheshwari" role="Data Analyst " />
                    <TeamMember IMG={PG} name="Parth Gupta" role="Full-Stack Developer" />
                    <TeamMember IMG={ND} name="Namish Dheer" role="AI Engineer" />
                </div>
            </motion.section>
        </div>
    )
