...
const Navbar = ({ token, setToken }) => {
  ...
  return (
    <nav className="fixed z-50 top-0 left-0 w-full h-20 bg-gray-900 bg-opacity-70 backdrop-blur-md justify-center shadow-md flex items-center">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 grid lg:grid-cols-7 grid-cols-2 justify-centre items-center w-full">
        {/* Logo */}
        ...
        <div className="hidden lg:flex col-span-6 lg:space-x-6 justify-center">
